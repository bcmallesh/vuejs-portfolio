...
public class ProjectController {
	...
	@RequestMapping(value = "/createproject", method = RequestMethod.POST,consumes = { "multipart/form-data","multipart/form-data","multipart/form-data"})
	public ProjectDto saveProjectInfo(@RequestPart("projectdata") ProjectDto projectdata,@RequestParam(name="thumnailimage", required=false) MultipartFile thumnailimage,@RequestParam(name="heroimage", required=false) MultipartFile heroimage,@RequestParam("sectionfiles") MultipartFile[] sectionfiles) {
	...
	@PreAuthorize("hasRole('ADMIN')")
	@RequestMapping(value = "/previewproject", method = RequestMethod.POST,consumes = { "multipart/form-data","multipart/form-data","multipart/form-data"})
	public ProjectSummary PreviewProjectInfo(@RequestPart("projectdata") ProjectDto projectdata,@RequestParam(name="thumnailimage", required=false) MultipartFile thumnailimage,@RequestParam(name="heroimage", required=false) MultipartFile heroimage,@RequestParam("sectionfiles") MultipartFile[] sectionfiles) {
